...
![image](./assets/img/t4-1.png)
![image](./assets/img/t4-2.png)
![image](./assets/img/t4-3.png)



- Modify the CSS to make the UI looks like the image below when `isLoggedIn` is `true`
![image](./assets/img/t4-4.png)
...
- Make sure the property textSecon`dCell can accept either a `string` or `number`
